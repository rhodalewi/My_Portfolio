        ...
        >
          ...
          <div className="inline-flex flex-col sm:flex-row justify-center md:items-center gap-5 md:gap-7 font-[Poppins] mt-4">
            ...
            <Link 
              ...
              smooth={true}
              duration={1000}
              className="flex items-center justify-center gap-2 px-3 py-2 md:px-6 md:py-2.5 rounded-lg font-medium border border-purple-500 hover:bg-purple-500/10 transition duration-300 text-sm md:text-base cursor-pointer"
            >
              Contact Me
